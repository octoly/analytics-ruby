...
module Octoly
  module Segment
    class Analytics
      class Client
        include Octoly::Segment::Analytics::Utils
        include Octoly::Segment::Analytics::Logging
        ...
        def add_context(context)
          context[:library] = { :name => 'analytics-ruby', :version => Octoly::Segment::Analytics::VERSION.to_s }
        end
